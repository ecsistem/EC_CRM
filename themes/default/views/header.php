        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <?php } ?>
                    <li><a href="<?= site_url('pos'); ?>" data-toggle="tooltip" data-placement="bottom" title="<?= lang('pos'); ?>"><i class="fa fa-th-large"></i></a></li>
                    ...
                    <li><a href="<?= site_url('pos'); ?>" data-toggle="tooltip" data-placement="bottom" title="<?= lang('pos'); ?>"><i class="svg-inline--fa fa-grid-2 fa-lg"></i></a></li>
                    ...
                    <?php } ?>
                    <li><a onclick="AtivarDesativarFS();" data-toggle="tooltip" data-placement="bottom" title="Tela Cheia"><i class="fa-solid fa-maximize"></i></a></li>
                    <script>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <?php } ?>
                <li class="mm_pos"><a href="<?= site_url('pos'); ?>"><i class="fa fa-th-large"></i> <span><?= lang('pos'); ?></span></a></li>
