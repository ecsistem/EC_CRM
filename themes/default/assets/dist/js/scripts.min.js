function cActions() {
    1 == Settings.rtl ? $(".modal-content .select2").select2({
        ...
        dragImageUpload: !1,
        dragFileUpload: !1
    }), $(":file").filestyle(), $(".validation").formValidation({
        framework: "bootstrap",
        excluded: ":disabled"
    })
}
...
function roundNumber(t, e) {
    switch (e) {
        case 1:
            a = formatDecimal(Math.round(20 * t) / 20);
            break;
        case 2:
...
function formatSA(t) {
    var e = "";
    (t = t.toString()).indexOf(".") > 0 && (e = t.substring(t.indexOf("."), t.length));
    ...
    $(".swipe").keypress(function (t) {
        ...
        if (13 == t.keyCode) {
            ...
            if (r.hasTrack1) {
                ...
                o = 4 == i ? "Visa" : 5 == i ? "MasterCard" : 3 == i ? "Amex" : 6 == i ? "Discover" : "Visa", $("#pcc_no_" + a).val(r.account), $("#pcc_holder_" + a).val(r.account_name), $("#pcc_month_" + a).val(r.exp_month), $("#pcc_year_" + a).val(r.exp_year), $("#pcc_cvv2_" + a).val(""), $("#pcc_type_" + a).val(o)
...
$(function () {
    ...
    cActions(), 1 == Settings.rtl ? $(".select2").select2({
        minimumResultsForSearch: 6,
        dir: "rtl"
    }) : $(".select2").select2({
        minimumResultsForSearch: 6
        ...
        $.get(e, function (t) {
            return $("#posModal").html(t), $("#posModal").modal({
                backdrop: "static"
            }), cActions(), !1
        })
    ...
    var e = Math.floor(t() / 1e3),
        a = date(dateformat + " " + timeformat, e);
    $(".clock").text(a), window.setInterval(function () {
        var e = Math.floor(t() / 1e3),
            a = date(dateformat + " " + timeformat, e);
        $(".clock").text(a)
    }, 1e4), $(".modal").each(function (t) {
    ...
    $(document).on("click", '[data-toggle="ajax-modal"]', function (t) {
        ...
        t.preventDefault();
        var e = $(this).attr("href");
        if (get("spositems")) return bootbox.confirm(lang.r_u_sure, function (t) {
        ...
        t.preventDefault();
        var e = $(this).attr("href");
        return bootbox.confirm("<strong>" + lang.register_open_alert + "</strong>", function (t) {
            1 == t && (window.location.href = e)
        }), !1
    })
});
